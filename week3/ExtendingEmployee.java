...
public class ExtendingEmployee {
    public static void main(String[] args) {
        Employee plain = new Employee("E101", "Alice", 40000.0);
        Employee mgr = new ManagerEmployee("M102", "Bob", 70000.0, 8000.0);
        Employee intern = new InternEmployee("I103", "Charlie", 12000.0, 10000.0);

        Employee[] employees = new Employee[] { plain, mgr, intern };
